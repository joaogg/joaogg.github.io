                ...
                <div class="col-md-8">
                    <center>
                        <div style="background-color: #ffffff; border-radius: 5px; padding: 10px 10px 10px 10px;"
                            ...
                            Guaxupé (2018).<br>
                            • Atualmente trabalho como Programador na Sellentt (manhã e tarde) e Auxiliar de Tecnologia II no CPD (Centro de Processamento de
                            Dados) do Centro Universitário da Fundação Educacional Guaxupé (noite).<br>
